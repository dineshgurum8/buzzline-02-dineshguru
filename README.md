...
py -m producers.kafka_producer_dineshguru
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.kafka_producer_dineshguru
```
...
```shell
.venv\Scripts\activate
py -m consumers.kafka_consumer_dineshguru
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.kafka_consumer_dineshguru
```
